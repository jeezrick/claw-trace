...
cp "$ROOT_DIR/server.js" "$ROOT_DIR/run.sh" "$ROOT_DIR/package.json" "$ROOT_DIR/README.md" "$ROOT_DIR/VERSION" "$ROOT_DIR/claw-trace" "$ROOT_DIR/install.sh" "$TMP_DIR/trace-service/"
